...
describe("forward eval contracts", () => {
  it("ships seven artifact-and-trace cases with auditable semantic graders", async () => {
    ...
    expect(Object.keys(manifest.cases).sort()).toEqual(["anti-procedure", "evolution", "genesis", "implementation", "reconciliation", "research-tools", "spec-derivation"]);
