...
function artifactMetadataIssues(data) {
  const issues = [];
  const allowed = /* @__PURE__ */ new Set(["id", "artifact_type", "title", "status", "created_by_change", "depends_on", "decisions", "supersedes", "writes_to", "implementation", "adr_status", "execution_id"]);
