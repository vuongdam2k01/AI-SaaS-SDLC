...
| `screen`, `component` | Client implementers and frontend test authors | What renders, what is refused, what must not change | Interface files, `UX-RULES`, `ERROR-CATALOG` | Conditions and exact responses; never restate wire fields |
