...
- Consistency model: <transactional, eventual, or other bounded semantics>
- Concurrency boundary: <conflict and serialization rule>
- Trust boundary: <validated inputs and protected outputs>
