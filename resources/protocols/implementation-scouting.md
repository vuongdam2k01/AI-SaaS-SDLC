...
2. **Blast radius.** Every caller, consumer and contract-sharer of the paths the segment will touch — from the packet's closure and from real reference searches, not assumption. This list feeds the definition of done's touchpoint walk and the reviewer's context.
